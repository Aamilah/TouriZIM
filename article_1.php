        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="d-flex flex-column text-left mb-4">
                    ...
                    <h1 class="mb-3">Great Zimbabwe Then</h1>
                ...
                <div class="media bg-primary text-white mb-5 p-4 p-md-5">
                    ...
                    <div class="media-body">
                        ...
                        <h7>Reference:https://www.nationalgeographic.org/encyclopedia/great-zimbabwe/</h7></p>
                    </div>
                </div>
